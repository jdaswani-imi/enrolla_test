...
export const tasks: Task[] = [
  ...
  { id: "TK-005", title: "Complete Khalil Mansouri onboarding profile", type: "HR", priority: "Medium", status: "In Progress", assignee: "Jason Daswani", dueDate: "16 Apr 2026", linkedRecord: null, description: "Home address and emergency contact still missing. Day 25 of onboarding.", subtasks: ["Send reminder to Khalil", "Verify submitted details"], overdue: false },
  ...
  { id: "TK-009", title: "CPD entry queried — Ahmed Khalil", type: "HR", priority: "Low", status: "Open", assignee: "Ahmed Khalil", dueDate: "22 Apr 2026", linkedRecord: null, description: "Classroom Management Webinar CPD entry queried. Please clarify hours and provider.", subtasks: ["Review query", "Provide clarification"], overdue: false },
  { id: "TK-010", title: "Update Sara Nasser concern record", type: "Academic", priority: "High", status: "Open", assignee: "Jason Daswani", dueDate: "17 Apr 2026", linkedRecord: { type: "student", name: "Sara Nasser", id: "IMI-0005" }, description: "L1 concern active for Y9 Maths. Log contact attempt with guardian.", subtasks: ["Review concern record", "Log contact note"], overdue: false },
  ...
  { id: "TK-013", title: "Prepare staff performance review — Ahmed Khalil", type: "HR", priority: "Low", status: "Open", assignee: "Jason Daswani", dueDate: "25 Apr 2026", linkedRecord: null, description: "Annual review due. Gather session delivery stats, CPD log, and feedback scores.", subtasks: ["Pull session stats", "Print CPD log", "Complete review form"], overdue: false },
  { id: "TK-014", title: "Follow up on lead L-0049 — Khalifa Rashid (DNC)", type: "Admin", priority: "Low", status: "Open", assignee: "Sarah Thompson", dueDate: "28 Apr 2026", linkedRecord: null, description: "DNC lead — verify DNC reason is logged. Confirm no further outreach is planned.", subtasks: ["Check DNC reason", "Archive lead if confirmed"], overdue: false },
  ...
  { id: "TK-016", title: "Weekly digest review", type: "Admin", priority: "Low", status: "Done", assignee: "Jason Daswani", dueDate: "14 Apr 2026", linkedRecord: null, description: "Review weekly activity digest and flag items for follow-up.", subtasks: ["Read digest", "Flag outstanding items"], overdue: false },
  { id: "TK-017", title: "Invoice reconciliation — Mar 2026", type: "Finance", priority: "Medium", status: "Done", assignee: "Jason Daswani", dueDate: "10 Apr 2026", linkedRecord: null, description: "Completed — all March invoices reconciled.", subtasks: ["Export CSV", "Cross-check", "File report"], overdue: false },
  { id: "TK-018", title: "Assign Y9 Science group to Tariq Al-Amin", type: "Academic", priority: "Medium", status: "Done", assignee: "Sarah Thompson", dueDate: "8 Apr 2026", linkedRecord: null, description: "New group assignment complete.", subtasks: ["Update timetable", "Notify teacher"], overdue: false },
  { id: "TK-019", title: "Send Term 2 parent satisfaction survey", type: "Admin", priority: "Low", status: "Done", assignee: "Sarah Thompson", dueDate: "5 Apr 2026", linkedRecord: null, description: "NPS survey dispatched to all active guardians.", subtasks: ["Prepare survey link", "Send batch", "Mark as sent"], overdue: false },
...
export const executionLogs: ExecutionLog[] = [
  { id: "EL-001", rule: "Absent Not Notified — Alert Admin", triggerType: "Threshold", firedAt: "14 min ago", recipients: 3, live: 0, queued: 3, status: "Success", duration: "142ms", payload: [{ key: "student_id", value: "IMI-0042" }, { key: "event", value: "absent_not_notified" }, { key: "session_date", value: "17 Apr 2026" }], conditionResults: [{ condition: "absence_notified = false", result: "pass" }, { condition: "session_status = Marked", result: "pass" }], actionResults: [{ type: "Send Message", outcome: "Success", target: "DQ-001 queued" }, { type: "Create Task", outcome: "Success", target: "Task created: T-0291" }], recipientRouting: [{ recipient: "Fatima Rahman", channel: "WhatsApp", route: "Queue", outcome: "Queued" }, { recipient: "Mona Salim", channel: "WhatsApp", route: "Queue", outcome: "Queued" }, { recipient: "Rami Khalil", channel: "Email", route: "Queue", outcome: "Queued" }] },
